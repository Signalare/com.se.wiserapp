...
const WiserDevice = require('./ZB_WiserDevice');

class WiserDeveloperDevice extends WiserDevice {

  async onNodeInit({ zclNode, node }) {
    this.debug('[WiserDeveloperDevice]', '[onNodeInit]', 'Developer mode detected.');
...
module.exports = WiserDeveloperDevice;
